...
- Route through `INDEX.md` into `admin/`, `data-sources/`, `eda/`, `field-management/`, `imagery/`, `soil/`, `strategy/`, or `weather/`. Row Crop Intelligence is nested under `field-management/row-crop-intelligence/`.
